...
/* package MyTicTacToe-0.1.0.0 */
#ifndef VERSION_MyTicTacToe
#define VERSION_MyTicTacToe "0.1.0.0"
#endif /* VERSION_MyTicTacToe */
#ifndef MIN_VERSION_MyTicTacToe
#define MIN_VERSION_MyTicTacToe(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_MyTicTacToe */
...
#define CURRENT_COMPONENT_ID "MyTicTacToe-0.1.0.0-inplace-MyTicTacToe"
